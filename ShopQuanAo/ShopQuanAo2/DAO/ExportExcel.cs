...
namespace ShopQuanAo2.DAO
{
    public class ExportExcel
    {
        public void Export(DataTable dt, string sheetName, string title)
        {
            ...
            Microsoft.Office.Interop.Excel.Range dl3 = oSheet.get_Range("D3", "D3");

            cl3.Value2 = "Số lượng";

            cl3.ColumnWidth = 40.0;

            Microsoft.Office.Interop.Excel.Range el3 = oSheet.get_Range("E3", "E3");

            cl3.Value2 = "Đơn giá";

            cl3.ColumnWidth = 40.0;

            Microsoft.Office.Interop.Excel.Range fl3 = oSheet.get_Range("F3", "F3");
